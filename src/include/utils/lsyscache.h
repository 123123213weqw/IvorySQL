...
extern Oid get_typrefbase(Oid typid);
extern char *get_object_ref_domain_name(const char *object_name);
extern Oid get_object_ref_domain_oid(Oid object_type, bool missing_ok);
